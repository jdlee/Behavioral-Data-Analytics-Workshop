...
## Simpson's Paradox
```{r simpons_pardox, echo = FALSE, warnings=FALSE, fig.height=5.25, fig.width=6.5, echo=FALSE}
library(scales)
set.seed(123)
n = 1000
...
```{r lmer_int, echo = TRUE, warnings=FALSE, fig.height=4, fig.width=10.25,prediction}
