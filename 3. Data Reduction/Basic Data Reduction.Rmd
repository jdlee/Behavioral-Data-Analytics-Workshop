...
## dplyr for Data Reduction|dplyr as grammar of data reduction
...
-- Plot with 25^th^ and 75^th^ quantiles if this is too easy
...
``broom'' for extracting model parameters and predictions
```{r join_data, echo = TRUE, warnings=FALSE, fig.height=3.75, fig.width=10.25}
library(broom)
